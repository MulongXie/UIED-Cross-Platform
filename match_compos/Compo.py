...
class Compo:
    def __init__(self, compo_id, ui_type, category, position, img_size, text_content=None):
        self.id = compo_id
    ...
    def draw_compo(self, board, ratio=None, color=(0,255,0), line=2, show_id=True, show=False):
        if not ratio:
